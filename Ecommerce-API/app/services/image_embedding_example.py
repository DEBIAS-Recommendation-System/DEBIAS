...
def example_image_embeddings():
    ...
    try:
        ...
        results = qdrant_service.search(
            query_vector=query_vector, limit=3, collection_name="product_images"
        )
...
def example_multimodal_products():
    ...
    qdrant_service.create_collection(
        collection_name="multimodal_products", vector_size=512
    )
    ...
    try:
        qdrant_service.insert_point(
            ...
            image_path=product["image_url"],
            payload={"product_name": product["name"], "category": "Electronics"},
        ...
        results = qdrant_service.search(
            query_vector=text_vector, limit=1, collection_name="multimodal_products"
        )
