    ...
    with open(csv_path, 'r', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            products_dict[product_id] = {
                ...
                'brand': row['brand'],
                'description': row['txt_amz_final'] if row['txt_amz_final'] else row['title']
            }
...
def search_products(query_text=None, query_image_url=None, collection_name="amazon_products", limit=5):
...
def main():
    ...
    if success_count > 0:
        ...
        print("=" * 70)
        print("\n💡 To search:")
        print("   • search_products(query_text='your search', collection_name='amazon_products')")
        print("   • search_products(query_image_url='image_url', collection_name='amazon_products')")
    else:
